    ...
    it "should increase the Monster count by 1" do
      get :new
        expect {post 'create', {monster:     {name: "Monkey", 
                                             ...
                                             cr: '.5',
                                             type: 'animal',
                                             environment: 'warm deserts'}}}.to change(Monster, :count).by(1)
      end

    it "should should render the new template if the monster isn't saved for any reason" do
      get :new
      post 'create', {monster:     {name: "Monkey", 
                                   # description: "a scourge on the trees",
                                   # description removed so that the monster is invalid
                                   visual_desc: "big, pesky",
                                   exp: 100,
                                   cr: '.5',
                                   type: 'animal',
